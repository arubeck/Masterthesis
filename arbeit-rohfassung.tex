...
\begin{document}
	...
	Survival analysis %erklären mit time to event
	is a pillar of statistical analysis of medical data. %insbesondere ist SA
	Such data could for example originate from case studies conducted over some period of time. %Beispiel Medikamenten Studie bzw kurz case studies erklären
	...
	Hence a fundamental issue is that if we do not observe the event we are presented with missing data. %which data is missing 
	As a consequence analysis of survival data requires special methods. %To deal with missing data an den Anfang?
	
	These methods often rely on assumptions about the data that might be too restrictive for complex data.
	An alternative approach is to apply deep learning algorithms. %To overcome these limitations
	...
	The term \say{network} suggests that the mapping $f$ is a composition of many different functions.
