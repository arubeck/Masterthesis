...
%	\todo[inline]{add sth about IPCW weights}
	...
	\begin{proof}
		...
		\todo{Ist das die richtige Uebersetzung für HDI?}
		then gives
		\begin{equation*}
	...
	To ensure that the empirical positivity assumption holds and that the empirical censoring function is not too small a truncation time $\tau$ is introduced.
