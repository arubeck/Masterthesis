...
\begin{document}
	...
	\todo[inline]{explain more detailed}
	...
	\todo[inline]{add parametric survival models}
	...
	\todo[inline]{add reference for these tests}
	
	If this assumption is not fullfilled, we can use a stratified Cox procedure instead.
	
	\todo[inline]{explain stratified cox model shortly OR add reference}
