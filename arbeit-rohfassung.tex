...
\begin{document}
	...
	To achieve this machine learning algorithms mainly consist of a task and a performance measure.
	...
	The performance measure then describes how well this task was achieved by calculating some sort of distinct between the predicted label and the real label that is given in the training sample.
	
	Machine learning algorithms can be classified according to what kind of experience they are allowed to have during the learning process.
