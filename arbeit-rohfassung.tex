...
\begin{document}
	...
	\subsection{(Semi-)Parametic Approaches to Estimation of Survival Time} \label{cox}
	...
	\todo[inline]{activation functions erklären}
	\todo[inline]{optimize loss function/performance measure to calculate weights for each unit with gradient based optimizers}
...
%	\todo[inline]{add sth about IPCW weights}
	...
	\begin{proof}
		...
		\end{equation*}
		The main theorem of integral calculus
	...
	The Mayo Clinic primary biliary cholangitis data ican be found in the \texttt{R} package \texttt{survival} and is provided by \citet*{survival-book}.
	...
	For further calculations we excluded cases with missing explanatory variables.
